...
public class MaterialsKevlar {
    ...
    // Can't remove this material cleanly
    ...
    public static Materials NaphthenicAcid = new MaterialBuilder(760, TextureSet.SET_FLUID, "Naphthenic Acid")
        ...
        .setFuelPower(80)
        .constructMaterial();
    public static Materials Hexachloroxylene = new MaterialBuilder(783, TextureSet.SET_FLUID, "Hexachloroxylene")
        .setName("Hexachloroxylene")
        .addCell()
        .addFluid()
        .setRGB(62, 8, 82)
